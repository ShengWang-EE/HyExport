...
\begin{figure}
    ...
    \caption{\textbf{Atlantic wind quality does not by itself determine the lowest offshore hydrogen cost.} \textbf{a} LCOH in the EEZs of the studied coastal European countries, with black lines outlining EEZ boundaries. \textbf{b} Country-level wind-speed probability densities. The vertical grey line in each density plot marks the modal wind speed. BE, DK, FR, DE, IE, NL, NO, PT, ES, SE and GB denote Belgium, Denmark, France, Germany, Ireland, the Netherlands, Norway, Portugal, Spain, Sweden and the United Kingdom, respectively.}
    \label{fig LCOH map}
\end{figure}
...
\begin{figure}
    ...
    \textbf{a--c}, Green-hydrogen cost-supply curves for 2030, 2040 and 2050, respectively. Solid lines indicate countries. Green and blue dots mark Ireland's and the UK's offshore wind capacity targets on their corresponding supply curves. Grey bands show the assumed future blue-hydrogen production-price range.}
