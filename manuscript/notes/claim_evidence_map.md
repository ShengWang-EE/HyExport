...
| Results, lines 202-208 | Denmark is most cost-competitive; Ireland and UK are sufficiently cost-competitive but need system-level assessment. | Fig. 2/LCOH curves and SI cost-rank figure; `LCOHcurve2030/2040/2050`, `averageLCOH`, `marginalLCOH`, `hyUnderBlue`. | Supported | Dense rank detail moved to SI; main text now uses cost evidence to set up the systems claim. |
