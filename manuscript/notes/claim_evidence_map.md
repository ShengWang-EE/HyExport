...
| Results, lines 202-208 | Denmark is most cost-competitive; Ireland and UK are mid-ranked but can still matter depending on supply-demand interaction. | Fig. 2/LCOH curves and Fig. 3/cost table; `LCOHcurve2030/2040/2050`, `averageLCOH`, `marginalLCOH`, `hyUnderBlue`. | Supported | Use this to set up the central systems claim. Move dense rank detail to SI if possible. |
