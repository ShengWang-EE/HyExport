function [X,P_bt, P_cp, P_el, P_wpd, massWater, q_hy, q_hy_inSCF] = electrolyzerSizing(OWFcapacity,year)
if nargin < 2
    year = 2030; % Baseline production-cost maps.
end
eta.electrolysor = electrolyserEfficiency(year);
...
equations = [
    ...
    massWater == q_hy * p_stp / R_gas / T_stp * M_water; % kg/s
