function [solution, solution_info,electricityGeneration,windCurtailment,gasDemand,GPPgasConsumption,interconnectorPower, ...
    electricityDemand] = unitCommitmentIreland(mpc,options,genTypeSet,onshoreWindAvaliableCapacity,onshoreSolarAvaliableCapacity,hydroAvaliableCapacity,interconnectorAvaliableCapacity, offshoreWindAvaliableCapacityCoeff, ...
    lonColumn,latColumn,LCOEcurve)
baseMVA = 100;
